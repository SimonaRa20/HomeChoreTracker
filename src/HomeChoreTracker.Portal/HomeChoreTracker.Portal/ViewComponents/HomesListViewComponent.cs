...
{
    public class HomesListViewComponent : ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly IConfiguration _config;
        private readonly ClaimsPrincipal _user;

        public HomesListViewComponent(IHttpClientFactory httpClientFactory, IConfiguration configuration, ClaimsPrincipal user)
        {
